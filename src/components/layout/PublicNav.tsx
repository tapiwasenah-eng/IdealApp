          ...
          <div className="hidden md:flex items-center gap-3">
            {isAuthenticated ? (
              ...
              <>
                ...
                <Link
                  to="/auth?mode=signup"
                  className="px-4 py-2 text-sm font-medium text-white bg-gray-800 hover:bg-gray-900 rounded-lg transition-colors shadow-sm"
                >
                  Sign Up
                </Link>
              </>
            ...
            {isAuthenticated ? (
              ...
              <>
                ...
                <Link
                  to="/auth?mode=signup"
                  onClick={() => setMobileOpen(false)}
                  className="block px-4 py-2.5 text-sm font-medium text-center text-white bg-gray-800 rounded-lg"
                >
                  Sign Up
                </Link>
              </>
